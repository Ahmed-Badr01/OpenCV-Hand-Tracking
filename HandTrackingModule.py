...
class HandDetector:
    ...
    def find_positions(self, frame, hand_num=0, show_all=True):
        ...
        if self.results.multi_hand_landmarks:
            ...
            for idx, landmark in enumerate(hand.landmark):  # We accessed this list through dot notation because it's
                # a NamedTuple object, which is a class in Python's Collections module.
